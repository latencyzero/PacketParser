       ...
       if (direct == eTo)
         {
           ...
           matmult( prec, nut, temp,3,3,3);
           matmult( temp, st, trans,3,3,3);
           matvecmult( trans, rpef, rgcrf);

           matvecmult(pm, vitrf,  vpef);
           cross( omegaearth, rpef, omgxr);
           addvec( 1.0, vpef, 1.0, omgxr, tempvec1);
           matvecmult( trans, tempvec1, vgcrf);
           ...
           matvecmult( trans, tempvec1, agcrf);
         }
         else
         {
           mattrans(pm, pmp, 3,3 );
...
void iau76fk5_itrf_j2k
     ...
     )
     {
       ...
       // ---- find matrices
       precess  ( ttt, e80,  psia,wa,epsa,chia,prec );
       nutation ( ttt,0.0,0.0,iau80rec,'c',  deltapsi,deltaeps, trueeps,meaneps,omega,  nut );
       sidereal ( jdut1,deltapsi,meaneps,omega,lod,eqeterms,  st,stdot );
       polarm   ( xp,yp,ttt,e80,  pm );
       ...
       if (direct == eTo)
         {
           ...
           matmult( prec, nut, temp, 3,3,3 );
           matmult( temp, st, trans, 3,3,3 );
           matvecmult( trans, rpef, rj2k);

           matvecmult(pm, vitrf,  vpef);
           cross( omegaearth, rpef, omgxr);
           addvec( 1.0, vpef, 1.0, omgxr, tempvec1);
           matvecmult( trans, tempvec1, vj2k);
           ...
           addvec( 1.0, apef, 1.0, omgxomgxr, tempvec);
           addvec( 1.0, tempvec, 2.0, omgxv, tempvec1);
           matvecmult( trans, tempvec1, aj2k);
         }
         else
         {
           mattrans(pm, pmp, 3,3 );
           ...
           matmult( stp, nutp, temp, 3,3,3 );
           matmult( temp, precp, trans, 3,3,3 );
           matvecmult(trans, rj2k,  rpef);
           matvecmult(pmp, rpef,  ritrf);

           cross( omegaearth, rpef, omgxr);
           matvecmult(trans, vj2k,  tempvec1);
           addvec( 1.0, tempvec1, -1.0, omgxr, vpef);
           matvecmult( pmp, vpef, vitrf);
           ...
           cross( omegaearth, vpef, omgxv);
           cross(omegaearth,omgxr, omgxomgxr);
           matvecmult( trans, aj2k, tempvec1);
           addvec( 1.0, tempvec1, -1.0, omgxomgxr, tempvec);
           addvec( 1.0, tempvec, -2.0, omgxv, apef);
           matvecmult( pmp, apef, aitrf);
         }
...
void iau76fk5_itrf_mod
     ...
     )
     {
       ...
       for (std::vector< std::vector<double> >::iterator it=trans.begin(); it != trans.end();++it)
            it->resize(3);
       std::vector< std::vector<double> > nut, st, stdot, pm, tempmat,
               pmp, stp, nutp, precp;
       ...
       // ---- find matrices
       nutation( ttt,ddpsi,ddeps,iau80rec,'c',  deltapsi,deltaeps, trueeps,meaneps,omega, nut );
       sidereal( jdut1,deltapsi,meaneps,omega,lod,eqeterms,  st,stdot );
       polarm  ( xp,yp,ttt,e80,  pm);
       ...
       if (direct == eTo)
         {
           matvecmult(pm, ritrf,  rpef);
           matmult( nut, st, tempmat, 3, 3, 3 );
           matvecmult( tempmat, rpef, rmod);

           matvecmult(pm, vitrf,  vpef);
           cross( omegaearth, rpef, omgxr);
           addvec( 1.0, vpef, 1.0, omgxr, tempvec1);
           matvecmult( tempmat, tempvec1, vmod);
           ...
           addvec( 1.0, apef, 1.0, omgxomgxr, tempvec);
           addvec( 1.0, tempvec, 2.0, omgxv, tempvec1);
           matvecmult( tempmat, tempvec1, amod);
         }
         else
         {
           mattrans(pm, pmp, 3, 3 );
           ...
           matmult( stp, nutp, tempmat, 3, 3, 3 );
           matvecmult(tempmat, rmod,  rpef);
           matvecmult(pmp, rpef,  ritrf);

           cross( omegaearth, rpef, omgxr);
           matvecmult(tempmat, vmod,  tempvec1);
           addvec( 1.0, tempvec1, -1.0, omgxr, vpef);
           matvecmult( pmp, vpef, vitrf);
           ...
           cross( omegaearth, vpef, omgxv);
           cross(omegaearth,omgxr, omgxomgxr);
           matvecmult( tempmat, amod, tempvec1);
           addvec( 1.0, tempvec1, -1.0, omgxomgxr, tempvec);
           addvec( 1.0, tempvec, -2.0, omgxv, apef);
           matvecmult( pmp, apef, aitrf);
         }
...
void pef_gcrf
     ...
     )
     {
       ...
       if (direct == eTo)
         {
           matmult( prec, nut, temp, 3, 3, 3 );
           matmult( temp, st, tempmat, 3, 3, 3 );
           matvecmult( tempmat, rpef, rgcrf);

           cross( omegaearth, rpef, omgxr);
           addvec( 1.0, vpef, 1.0, omgxr, tempvec1);
           matvecmult( tempmat, tempvec1, vgcrf);

           cross(omegaearth,omgxr, omgxomgxr);
           cross( omegaearth, vpef, omgxv);
           addvec( 1.0, apef, 1.0, omgxomgxr, tempvec);
           addvec( 1.0, tempvec, 2.0, omgxv, tempvec1);
           matvecmult( tempmat, tempvec1, agcrf);
         }
         else
         {
           mattrans(st, stp, 3, 3 );
           ...
           matmult( stp, nutp, temp, 3, 3,3 );
           matmult( temp, precp, tempmat, 3, 3,3 );
           matvecmult(tempmat, rgcrf,  rpef);

           cross( omegaearth, rpef, omgxr);
           matvecmult(tempmat, vgcrf,  tempvec1);
           addvec( 1.0, tempvec1, -1.0, omgxr, vpef);

           addvec( 1.0, tempvec1, -1.0, omgxr, vpef);
           cross( omegaearth, vpef, omgxv);
           cross(omegaearth,omgxr, omgxomgxr);
           matvecmult( tempmat, agcrf, tempvec1);
           addvec( 1.0, tempvec1, -1.0, omgxomgxr, tempvec);
           addvec( 1.0, tempvec, -2.0, omgxv, apef);
         }
     }  // procedure pef_gcrf
...
void tod_gcrf
     ...
     )
     {
       ...
       if (direct == eTo)
         {
            matmult( prec, nut, tempmat, 3, 3, 3 );
          ...
          else
          {
            mattrans(nut, nutp, 3, 3 );
            mattrans(prec, precp, 3, 3 );
            matmult( nutp, precp, tempmat, 3, 3, 3 );
...
void teme_j2k
     (
      ...
      {
        std::vector< std::vector<double> >  prec, nutteme, tempmat,
               nuttemep, precp;
        double psia, wa, epsa, chia;

        precess ( ttt, e80,  psia,wa,epsa,chia,  prec );
        truemean( ttt,order,eqeterms,optteme, iau80rec, nutteme );

        if (direct == eTo)
          {
            matmult( prec, nutteme, tempmat, 3, 3, 3 );
            matvecmult( tempmat, rteme, rj2k);
            matvecmult( tempmat, vteme, vj2k);
            matvecmult( tempmat, ateme, aj2k);
          }
          else
          {
            mattrans(nutteme, nuttemep, 3, 3 );
            mattrans(prec, precp, 3, 3 );

            matmult( nuttemep, precp, tempmat, 3, 3, 3 );
            matvecmult(tempmat, rj2k, rteme);
            matvecmult(tempmat, vj2k, vteme);
            matvecmult(tempmat, aj2k, ateme);
          }
      }  // procedure teme_j2k
...
void teme_pef
     (
     ...
     )
      {
        ...
        if (direct == eTo)
          {
            matvecmult( tm, rteme, rpef);
            matvecmult( tm, vteme, vpef);
            matvecmult( tm, ateme, apef);
          }
          else
          {
            mattrans(tm, tmp, 3, 3 );
            matvecmult(tmp, rpef, rteme);
            matvecmult(tmp, vpef, vteme);
            matvecmult(tmp, apef, ateme);
          }
      }  // procedure teme_pef
