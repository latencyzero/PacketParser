...
void rv2coe
     ...
     {
       double mu, small, hbar[3], nbar[3], magr, magv, magn, ebar[3], sme,
...
void rv2rsw
     ...
     )
     {
       ...
       matvecmult  ( transmat, r, rrsw );
       matvecmult  ( transmat, v, vrsw );
/*
*   alt approach
*       rrsw[0] = mag(r)
*       rrsw[2] = 0.0
...
void  rv2ntw
      ...
      )
   {
      ...
      matvecmult  ( transmat, r, rntw );
      matvecmult  ( transmat, v, vntw );
   }  // procedure rv2ntw
...
void ijk2ll
     (
       const double recef[3], double jdut1,
